...
count = 1000  # num of images to generate
batch = 50  # size of a single batch
begin = 0  # indicate the current index, use only if you are continuing a crashed generation
image_dir = "C:/Users/Matthew/Desktop/Mobile Robotics - Personal Project/photos/original - pipeline/images"
mask_dir = "C:/Users/Matthew/Desktop/Mobile Robotics - Personal Project/photos/original - pipeline/masks"
extension = "*.jpg"
out_dir = "C:/Users/Matthew/Desktop/Mobile Robotics - Personal Project/photos/original - pipeline/augmentation"  # out directory
background_file = "C:/Users/Matthew/Desktop/Mobile Robotics - Personal Project/photos/original - pipeline/backgrounds/*.jpg"
mask_list = [
"black_rect_sm",
"blue_rect_lg",
"blue_rect_md",
...
collated_images_and_masks = list(zip(overall_list[0], overall_list[1], overall_list[2], overall_list[3], overall_list[4], overall_list[5], overall_list[6], overall_list[7], overall_list[8]))
...
#p.skew(1, .8)
p.flip_random(1)
p.random_distortion(.3, 4, 4, 3)
#p.random_color(1, .3, 1.2)
p.random_contrast(1, 1, 1.5)
...
for i in range(begin//batch, count//batch):
    ...
    for j in range(batch):
        ...
        original = cv2.resize(original, (640, 480), interpolation=cv2.INTER_CUBIC)
        ...
        if alpha is None:
            ...
            orig_grey = cv2.resize(orig_grey, (640, 480), interpolation=cv2.INTER_CUBIC)
        ...
        outImage = cv2.resize(outImage, (640, 480), interpolation=cv2.INTER_AREA)
        ...
        if len(result_eval[0]) > 0.5 * 480 * 640 * 3:
